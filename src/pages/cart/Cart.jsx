...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_rCk5dXq2blcDXa",
      key_secret: "J7wF017p0Ufs7Fl4Vmm2EV1q",
      ...
      handler: function (response) {
        ...
        try {
            // Ensure fireDB is initialized properly
      if (!fireDB) {
        throw new Error("Firestore database is not initialized");
      }

        // Reference the 'order' collection and add a new document
